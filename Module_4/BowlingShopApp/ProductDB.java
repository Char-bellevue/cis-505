     ...
     */
     public static GenericQueue<Product> getProducts(String lCode) {
        ...
        // Check if the user's selection is "a" for bowling bags.
            ...
            // Create a generic queue named shoes to hold bag product objects, as specified in the assignment.
            GenericQueue<Product> shoes = new GenericQueue<>();
            ...
            // Add all three bag objects to the queue named shoes per the assignment specification.
            shoes.enqueue(lBag1);
            shoes.enqueue(lBag2);
            shoes.enqueue(lBag3);
